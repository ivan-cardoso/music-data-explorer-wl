...
//   // try {
//     const albumData = await getAlbumInfo(artist, album);
//     const albumFormatted = transformAlbum(albumData);
//     const insights = albumFormatted.tracks ? calculateAlbumInsights(albumFormatted.tracks) : null;

//     return (
//       <div className="min-h-screen bg-background">
//         <Navbar />
//         {console.log("ALBUM DATA:", albumFormatted)}
//         <main className="container mx-auto px-4 py-8">
//           <div className="flex flex-col md:flex-row gap-8 items-start">
//             <img
//               src={
//                 albumFormatted.image ||
//                 "/placeholder.svg?height=300&width=300&query=album+cover"
//               }
//               alt={albumFormatted.name}
...
//                     {formatNumber(albumFormatted.listeners || 0)}
//                   </div>
//                 </div>
//                 <div>
//                   <div className="text-sm text-muted-foreground">Playcount</div>
//                   <div className="text-2xl font-bold text-primary">
//                     {formatNumber(albumFormatted.playcount)}
//                   </div>
//                 </div>
//               </div>

//               {albumFormatted.tags && albumFormatted.tags.length > 0 && (
//                 <div className="flex flex-wrap gap-2 mb-6">
//                   {albumFormatted.tags.slice(0, 5).map((tag, index) => (
//                     <Badge
//                       key={index}
//                       variant="secondary"
...
//                   {stripHtmlTags(albumFormatted.wiki).slice(0, 300)}...
//                 </p>
//               )}
//             </div>
//           </div>
...
//           {albumFormatted.tracks && albumFormatted.tracks.length > 0 && (
//             <>
//               <div className="mt-12">
//                 <h2 className="text-2xl font-bold mb-6 text-foreground">
//                   Tracklist
//                 </h2>
//                 <AlbumTrackList tracks={albumFormatted.tracks} />
//               </div>
...
//                 </h2>
//                 <AlbumDurationChart tracks={albumFormatted.tracks} />
//               </div>
//             </>
//           )}
//         </main>
...
//               Could not find "{album}" by {artist}
//             </p>
//           </div>
//         </main>
//       </div>
