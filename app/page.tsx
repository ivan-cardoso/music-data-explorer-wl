...
export default async function Home() {
  ...
  try {
    const [artistsData, tracksData] = await Promise.all([getTopArtists(10), getTopTracks(10)])
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {error ? (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mt-2">Please check your Last.fm API configuration</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16">
            <div>
              <h2 className="text-2xl font-bold mb-6 text-foreground">Trending Artists</h2>
